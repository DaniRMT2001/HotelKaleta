...
include 'conex.php'; 
 ...
 $query = "SELECT reserva.id_res, reserva.id_usu,reserva.id_hab,reserva.fecha_entrada,reserva.fecha_salida,reserva.habitacion_res, reserva.personas_res,habit.imagen,usuario.nombre_usu,reserva.estado FROM reserva INNER JOIN habit ON reserva.id_hab=habit.id_hab INNER JOIN usuario on reserva.id_usu=usuario.id_usu WHERE reserva.estado='activo' and reserva.id_usu='{$id}';";
